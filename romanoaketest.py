...
def parselyrics(artist_name, track_num, album_name, release_year, track_name):
    ...
    file_path_lrc = f"C:/Users/mirun/Downloads/romanoake2/romanoake2/Lyrics/{artist_name}/{album_folder}/{track_file}.lrc"
#"C:\Users\mirun\Downloads\romanoake2\romanoake2\Lyrics"
    try:
        folder_path = f'C:/Users/mirun/Downloads/romanoake2/romanoake2/Lyrics/{artist_name}/{album_folder}'
                ...
                if match:
                    ...
                    while(i < limit):
                        ...
                        while(j <= i):
                            ...
                            if (currentscript != script and script != "HK" and (currentscript != "Hiragana" and currentscript != "Katakana" and currentscript != "Hani") and (script != "Hiragana" and currentscript != "Katakana" and script != "Hani")):
...
def audio_analysis():
    ...
    for i in range(len(lyrics_data)):  # Loop until the second last entry
        ...
        for j, segment in enumerate(segments):
            if (segment['start'] > (timestamp_start/1000)) and ((segment['duration'] + segment['start']) < (timestamp_end/1000)) and (segment['confidence'] > 0.5):
        ...
        track_analysis.append({'timestamp': timestamp_start, 'lyrics': current_line['lyrics'], 'analysis': timbre_groupings, 'artist': current_line['artist']})
...
def set_auth():
    ...
    if authorization_bearer != "":
        ...
        print("NIGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA")
